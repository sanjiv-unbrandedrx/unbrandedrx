      ...
      <div className="flex flex-col justify-between gap-x-4 xl:flex-row xl:items-stretch">
        <div className="relative h-full min-h-[590px] w-full overflow-hidden rounded-3xl">
          ...
          <Image
            ...
            alt="Hairfect Rx - The 8-in-1 perfect prescription hair loss formula"
            fill
        ...
        <div className="flex w-full flex-col gap-y-10 py-6 px-1 xl:py-0 xl:px-19">
          <div className="space-y-3">
            <p className="font-title text-2xl font-medium tracking-tight xl:text-4xl">
              Hairfect Rx - The 8-in-1 perfect prescription hair loss formula
            </p>
            <p className="text-sm xl:text-base">
              Ditch your hair supplements. One convenient hair supplement with
              prescription ingredients in just one capsule.
            </p>
            ...
            <ul className="flex list-none list-inside flex-col gap-y-1 text-xs text-muted-foreground">
              <li>
                <span>✓&nbsp;</span>Helps address hair loss
              </li>
              <li>
                <span>✓&nbsp;</span>Fast-acting, short-duration formula
              </li>
              <li>
          ...
          {isClient && (
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="standard">Hair Caps 6.0</SelectItem>
                  <SelectItem value="high">Hair Caps 7.0</SelectItem>
                  <SelectItem value="very-high">Hair Caps 8.0</SelectItem>
                </SelectContent>
              </Select>
            </div>
          )}
