export default function DeepDiveSection() {
  return (
    <section className="my-15 container mx-auto py-10 px-4 xl:px-0">
      <div className="flex justify-between gap-x-19">
        <div className="flex-1 bg-[url('/products/key-ingredients.png')] bg-center bg-cover rounded-3xl  min-h-[522px]">
          <div className="bg-gradient-to-b from-white/20 to-white w-full h-full flex flex-col gap-y-5 justify-end items-start py-8 px-10">
