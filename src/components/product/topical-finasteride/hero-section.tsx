      ...
      <div className="flex flex-col justify-between gap-x-4 xl:flex-row xl:items-stretch">
        <div className="relative h-full min-h-[590px] w-full overflow-hidden rounded-3xl">
          <Image
            ...
            fill
            // CONSISTENCY FIX: Changed object-cover/right to object-contain/center
        ...
        <div className="flex w-full flex-col gap-y-10 py-6 px-1 xl:py-0 xl:px-19">
          <div className="space-y-3">
            ...
            {/* TASK 33: Update product sub-description */}
            ...
            {/* TASKS 35 & 47: Replaced old list with new icon-based feature list */}
          ...
          {/* CONSISTENCY FIX: Added checkout link */}
          <a
          ...
          {/* TASK 41: Add collapsible safety information section */}
              ...
              <AccordionContent className="text-xs space-y-4">
                ...
                <div>
                  ...
                  <p>
                    ...
                    may include sexual side effects. Seek emergency help for
