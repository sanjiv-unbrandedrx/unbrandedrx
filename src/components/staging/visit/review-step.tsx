    ...
    <div className="space-y-8">
      ...
      <FadeIn delay={0.1}>
        <div className="rounded-2xl border border-neutral-200 overflow-hidden">
          <div className="bg-zinc-50 px-5 py-3 border-b border-neutral-200">
            <h3 className="font-title font-semibold">Your Treatment Plan</h3>
          </div>
          <div className="p-5 space-y-3">
            {state.treatmentPlan.map((t) => (
              <div key={t.treatmentId} className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold font-title">{t.name}</p>
      ...
      <FadeIn delay={0.2}>
        <div className="rounded-2xl border border-neutral-200 overflow-hidden">
          <div className="bg-zinc-50 px-5 py-3 border-b border-neutral-200">
            <h3 className="font-title font-semibold">Your Responses</h3>
          </div>
          <div className="divide-y divide-neutral-100">
            {Object.entries(answeredBySection).map(
              ([section, questions]) => (
                <div key={section} className="p-5 space-y-4">
      ...
      {/* Submit */}
      <FadeIn delay={0.3}>
        <div className="rounded-2xl border border-neutral-200 bg-zinc-50 p-6 text-center space-y-4">
          <p className="text-sm text-muted-foreground">
