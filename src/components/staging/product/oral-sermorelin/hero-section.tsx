...
import { Activity, Pill, Moon, ShieldCheck, Beaker } from "lucide-react";
    ...
    <section className="container mx-auto my-4 px-4 xl:my-15 xl:px-0">
      <div className="flex flex-col justify-between gap-x-4 xl:flex-row xl:items-stretch">
        <div className="relative h-full min-h-[590px] w-full overflow-hidden rounded-3xl flex items-center justify-center bg-neutral-50">
          <Image
            src="/products/oral-sermorelin-hero.png"
            alt="Oral Sermorelin"
            fill
        ...
        <div className="flex w-full flex-col gap-y-10 py-6 px-1 xl:py-0 xl:px-19">
          <div className="space-y-3">
            ...
            <p className="text-sm xl:text-base">
              ...
              support deeper sleep, faster recovery, energy, and metabolic
              health.
            </p>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-start gap-x-3">
                <Pill className="size-5 text-primary flex-shrink-0" />
                <p className="text-sm text-muted-foreground">
                  Convenient oral lozenge — no needles or injections required.
                </p>
              </div>
              <div className="flex items-start gap-x-3">
          ...
          <a
            href="https://checkout.unbrandedrx.co/oral-sermorelin"
            target="_blank"
            ...
            <AccordionItem value="item-1" className="border-b-0">
              ...
              <AccordionContent className="text-xs space-y-4">
                ...
                <div>
                  ...
                  <p>
                    To ensure Oral Sermorelin is safe for you, inform your
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Common side effects of Oral Sermorelin may include:
                  </p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>Headache</li>
