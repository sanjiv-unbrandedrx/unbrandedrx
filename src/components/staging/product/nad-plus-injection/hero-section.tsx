        ...
        <div className="flex w-full flex-col gap-y-10 py-6 px-1 xl:py-0 xl:px-19">
          <div className="space-y-3">
            ...
            <p className="text-sm xl:text-base">
              A prescription-grade NAD+ injection designed to replenish a vital
              coenzyme that declines with age. Supports cellular energy, mental
              clarity, DNA repair, and healthy aging.
            </p>
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-start gap-x-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Supports cellular energy production at the mitochondrial
                  level.
                </p>
              </div>
              <div className="flex items-start gap-x-3">
                <Brain className="size-5 text-primary flex-shrink-0" />
                <p className="text-sm text-muted-foreground">
                  Promotes sharper cognitive function and mental clarity.
                </p>
              </div>
              <div className="flex items-start gap-x-3">
                <Syringe className="size-5 text-primary flex-shrink-0" />
                <p className="text-sm text-muted-foreground">
                  Simple subcutaneous injection — bypasses digestive breakdown.
                </p>
              </div>
              <div className="flex items-start gap-x-3">
          ...
          <a
            href="https://checkout.unbrandedrx.co/nad-plus-injection"
            target="_blank"
              ...
              <AccordionContent className="text-xs space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>
                      You have a known hypersensitivity to NAD+ or any component
                      of the formulation.
                    </li>
                    <li>
                    ...
                    <li>
                      You have active cancer or are currently undergoing cancer
                      treatment.
                    </li>
                    <li>
                      You have an uncontrolled chronic illness or active
                      infection.
                    </li>
                ...
                <div>
                  ...
                  <p>
                    To ensure NAD+ Injection is safe for you, inform your
                    provider if you have ever had:
                  </p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>
                      Cardiovascular disease or severe cardiac conditions
                    </li>
                    <li>Severe kidney or liver disease</li>
                    <li>Diabetes or blood sugar management issues</li>
                    <li>Autoimmune disorders</li>
                    <li>Cancer history or prior cancer treatment</li>
                    <li>
                      If you take blood-thinning medications or
                ...
                <div>
                  ...
                  <p>
                    ...
                    (hives, difficulty breathing, rapid heartbeat, swelling of
                    your face, lips, tongue, or throat).
                  </p>
                  <p className="mt-2">
                    Common side effects of NAD+ Injection may include:
                  </p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li>Mild warmth or flushing</li>
                    <li>Lightheadedness</li>
                    <li>Mild temporary fatigue</li>
                    <li>Mild nausea</li>
                    <li>
