...
export default function HeroSection() {
  ...
  return (
    <section className="container mx-auto pb-20 bg-none xl:bg-[url(/home/sexual-health.webp)] bg-right bg-cover bg-no-repeat px-4 xl:px-6">
      <Header />
      <Breadcrumb className="mt-4 mb-9 container mx-auto">
        <BreadcrumbList className="lowercase text-xs font-light tracking-tight">
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/find/category/sexual-health">
