// @/components/category/testosterone/hero-section.tsx
    ...
    <section className="container mx-auto pb-20 bg-none xl:bg-[url(/categories/hair-loss.webp)] bg-right bg-cover bg-no-repeat px-4 xl:px-0">
      ...
      <div className="max-w-md space-y-6 mb-9">
        <h1 className="font-title font-medium text-2xl xl:text-4xl tracking-tight">
          Testosterone Support Treatments.
          <br />
          No Brand Markup.
        </h1>
        <p className="font-light text-xl xl:text-2xl text-muted-foreground">
          Get clinically-backed treatments to support natural testosterone
          production, prescribed by licensed providers.
        </p>
      </div>
