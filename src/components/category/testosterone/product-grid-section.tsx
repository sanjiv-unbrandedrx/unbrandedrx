// @/components/category/testosterone/product-grid-section.tsx
...
const TESTOSTERONE_PRODUCTS: ProductItem[] = [
  {
    id: "enclomiphene",
    name: "Enclomiphene",
...
export default function ProductGridSection() {
  return (
    ...
    <section id="products" className="container mx-auto px-4 xl:px-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-5">
        {TESTOSTERONE_PRODUCTS.map((product) => (
