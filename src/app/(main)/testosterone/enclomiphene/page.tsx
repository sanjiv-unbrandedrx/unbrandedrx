...
export const metadata: Metadata = {
  title: "Enclomiphene — Natural Testosterone Support",
  description:
...
export default function EnclomipheneV2Page() {
  return (
    <main>
      <ProductJsonLd
        name="Enclomiphene"
        description="Boost testosterone naturally with Enclomiphene. A daily oral capsule that stimulates your body's own production."
        image="/products/enclomiphene-hero.png"
        price="79.00"
        sku="enclo-citrate-v2"
        url="/testosterone/enclomiphene"
      />
